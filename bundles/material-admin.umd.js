...
(function (global, factory) {
    ...
    (global = global || self, factory((global.dewco = global.dewco || {}, global.dewco.material = global.dewco.material || {}, global.dewco.material.admin = {}), global.ng.common, global.ng.core, global.ng.forms, global.ng.material.button, global.ng.material.card, global.ng.material.checkbox, global.ng.material.dialog, global.ng.material.formField, global.ng.material.icon, global.ng.material.input, global.ng.material.paginator, global.ng.material.progressBar, global.ng.material.radio, global.ng.material.select, global.ng.material.sort, global.ng.material.table, global.ng.material.toolbar, global.ng.router, global.ngxt.core, global.gngt.core.common, global.gngt.core.admin, global.ng.cdk.collections));
}(this, function (exports, common, core, forms, button, card, checkbox, dialog, formField, icon, input, paginator, progressBar, radio, select, sort, table, toolbar, router, core$1, common$1, admin, collections) { 'use strict';
